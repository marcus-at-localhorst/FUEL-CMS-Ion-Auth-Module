...
*/
$config['tables']['users']           = 'iauth_users';
$config['tables']['groups']          = 'iauth_groups';
$config['tables']['users_groups']    = 'iauth_users_groups';
$config['tables']['login_attempts']  = 'iauth_login_attempts';
